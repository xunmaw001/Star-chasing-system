	...
	<view class="content">
		<view @tap="onPageTap('../user-info/user-info')" class="header" v-bind:class="{'status':isH5Plus}" :style='{"backgroundColor":"rgba(153, 102, 102, 1)","height":"200rpx"}'>
																								...
																								<view v-if="tableName=='yonghu'" class="userinfo">
																																																								<view class="info">
															<view class="username" :style='{"boxShadow":"0 0 16rpx rgba(255,255,255,0)","backgroundColor":"rgba(0,0,0,0)","borderColor":"rgba(255,255,255,.3)","borderRadius":"8rpx","color":"#fff","textAlign":"left","borderWidth":"0","width":"240rpx","lineHeight":"36rpx","fontSize":"24rpx","borderStyle":"solid"}'>{{user.yonghuzhanghao}}</view>
																																																																</view>
			</view>
					...
					<view v-bind:key="sort" v-for=" (child,sort) in menu.child">
						<view :style='{"backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"rgba(153, 102, 102, 1)","lineHeight":"100rpx","borderStyle":"solid solid solid solid ","borderWidth":"0 2rpx 2rpx 20rpx"}' v-if="child.tableName!='yifahuodingdan' && child.tableName!='yituikuandingdan' &&child.tableName!='yiquxiaodingdan' && child.tableName!='weizhifudingdan' && child.tableName!='yizhifudingdan' && child.tableName!='yiwanchengdingdan' " @tap="onPageTap('../'+child.tableName+'/list?userid='+user.id)" class="li" hover-class="hover">
							...
							<view class="cuIcon-right" :style='{"color":"#333","fontSize":"28rpx"}'></view>
																																										...
																																										<view @tap="onPageTap('../messages/list')" :style='{"backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"rgba(153, 102, 102, 1)","lineHeight":"100rpx","borderStyle":"solid solid solid solid ","borderWidth":"0 2rpx 2rpx 20rpx"}' class="li" hover-class="hover">
