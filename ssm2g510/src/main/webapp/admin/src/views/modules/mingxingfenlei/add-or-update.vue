<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="明星分类" prop="mingxingfenlei">
          <el-input v-model="ruleForm.mingxingfenlei" 
              placeholder="明星分类" clearable  :readonly="ro.mingxingfenlei"></el-input>
        </el-form-item>
        <div v-else>
...
export default {
  data() {
	...
	mingxingfenlei : false,
            ...
            ruleForm: {
                          ...
                          rules: {
                  mingxingfenlei: [
                            { required: true, message: '明星分类不能为空', trigger: 'blur' },
                                    	                                                              ],
              }
    };
  },
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `mingxingfenlei/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.mingxingfenleiCrossAddOrUpdateFlag = false;
                  this.parent.search();
