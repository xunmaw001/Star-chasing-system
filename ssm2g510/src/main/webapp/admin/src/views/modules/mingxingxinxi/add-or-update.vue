<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="明星姓名" prop="mingxingxingming">
          <el-input v-model="ruleForm.mingxingxingming" 
              placeholder="明星姓名" clearable  :readonly="ro.mingxingxingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="明星姓名" prop="mingxingxingming">
              <el-input v-model="ruleForm.mingxingxingming" 
                placeholder="明星姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="代表作" prop="daibiaozuo">
          <el-input v-model="ruleForm.daibiaozuo" 
              placeholder="代表作" clearable  :readonly="ro.daibiaozuo"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="代表作" prop="daibiaozuo">
              <el-input v-model="ruleForm.daibiaozuo" 
          ...
          <el-form-item class="input" label="性别" prop="xingbie">
              <el-input v-model="ruleForm.xingbie" 
                placeholder="性别" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="明星分类" prop="mingxingfenlei">
          <el-select v-model="ruleForm.mingxingfenlei" placeholder="请选择明星分类">
            <el-option
                v-for="(item,index) in mingxingfenleiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="明星分类" prop="mingxingfenlei">
	      <el-input v-model="ruleForm.mingxingfenlei"
                placeholder="明星分类" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="体重" prop="tizhong">
              <el-input v-model="ruleForm.tizhong" 
                placeholder="体重" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="星座" prop="xingzuo">
          <el-input v-model="ruleForm.xingzuo" 
              placeholder="星座" clearable  :readonly="ro.xingzuo"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="星座" prop="xingzuo">
              <el-input v-model="ruleForm.xingzuo" 
                placeholder="星座" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="24">  
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.shipin" label="视频" prop="shipin">
            <el-button type="text" size="small" @click="download(ruleForm.shipin)">预览</el-button>
                                                                                                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                                                                                                            <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="行程" prop="xingcheng">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.xingcheng" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.xingcheng" label="行程" prop="xingcheng">
                    <span v-html="ruleForm.xingcheng"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
    ...
    return {
      ...
      type: '',
      ro:{
	mingxingxingming : false,
	daibiaozuo : false,
	xingbie : false,
	mingxingfenlei : false,
	nianling : false,
	shengao : false,
	tizhong : false,
	xingzuo : false,
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          	            if(o=='mingxingxingming'){
            this.ruleForm.mingxingxingming = obj[o];
	    this.ro.mingxingxingming = true;
            continue;
          }
	            	            if(o=='daibiaozuo'){
            this.ruleForm.daibiaozuo = obj[o];
	    ...
	    this.ro.xingbie = true;
            continue;
	            	            ...
	            	            if(o=='mingxingfenlei'){
            this.ruleForm.mingxingfenlei = obj[o];
	    this.ro.mingxingfenlei = true;
            continue;
          }
	            	            if(o=='nianling'){
	    ...
	    this.ro.tizhong = true;
            continue;
	            	            ...
	            	            if(o=='xingzuo'){
            this.ruleForm.xingzuo = obj[o];
	    this.ro.xingzuo = true;
            continue;
          }
	            	            if(o=='touxiang'){
	    ...
	    this.ro.shipin = true;
            continue;
	            	            ...
	            	            if(o=='xingcheng'){
            this.ruleForm.xingcheng = obj[o];
	    this.ro.xingcheng = true;
            continue;
          }
	            	            if(o=='thumbsupnum'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `mingxingxinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.mingxingxinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
